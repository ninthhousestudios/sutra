...
fn boundary_resolution_with_membership() {
    ...
    db.upsert_clustering_meta(0, 4, "h1").unwrap();
...
fn cache_hit_on_unchanged_membership() {
    ...
    db.upsert_clustering_meta(0, 2, "h1").unwrap();
...
fn cache_miss_on_membership_change() {
    ...
    db.upsert_clustering_meta(0, 3, "h1").unwrap();
    ...
    db.upsert_clustering_meta(0, 3, "h2").unwrap();
