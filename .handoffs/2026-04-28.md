...
### resolver improvement (this session)
...
- **Hooks** -- sutra is meant to replace /home/josh/soft/qartez-mcp/ qartez uses hooks
to make the agent uses qartez. Does sutra have such hooks? If not, we want them.
